...
# The child element <dimensions> contains measurements (already retrieved for 'height' and 'width'), which must be removed
...
full_provenance = elem_to_text(provenance_data)
print(provenance)
...
27 = width
28 = alt_size
29 = miniatures_fullpage
30 = miniatures_large
31 = miniatures_small
32 = miniatures_unspec_size
33 = initials_historiated
34 = initials_decorated
35 = manuscript_binding
36 = manuscript_link
37 = other_info
38 = provenance
'''
...
new_CSV_row[10] = ''
new_CSV_row[11] = ''
# 'Sale price' [12] to be left blank; no elements/attributes in TEI encoding scheme pertain to concept
new_CSV_row[12] = ''
new_CSV_row[13] = titles
new_CSV_row[14] = authors
new_CSV_row[15] = dates
# 'Scribes'[16] to be left blank; no elements/attributes in TEI encoding scheme pertain to concept
new_CSV_row[16] = ''
# 'Artists'[17] to be left blank; no elements/attributes in TEI encoding scheme pertain to concept
new_CSV_row[17] = ''
new_CSV_row[18] = languages
new_CSV_row[19] = materials
new_CSV_row[20] = places
# 'Uses' [21] to be left blank; no elements/attributes in TEI encoding scheme pertain to concept
new_CSV_row[21] = ''
# 'Missing Authority Names' [22] to be left blank
new_CSV_row[22] = ''
# 'Folios' [23] to be left blank; expects a single numerical value, which cannot reliably be extracted
new_CSV_row[23] = ''
new_CSV_row[24] = num_columns
new_CSV_row[25] = num_lines
new_CSV_row[26] = height
new_CSV_row[27] = width
# 'Alt size' to be left blank; used for other measurements within restrited values
new_CSV_row[28] = ''
# Indices 29-34 are to be left blank; expects numerical values, which cannot reliably be extracted
new_CSV_row[29] = ''
new_CSV_row[30] = ''
new_CSV_row[31] = ''
new_CSV_row[32] = ''
new_CSV_row[33] = ''
new_CSV_row[34] = ''
new_CSV_row[35] = binding
new_CSV_row[36] = manuscript_link
new_CSV_row[37] = ''
new_CSV_row[38] = provenance_agent
